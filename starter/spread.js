...
console.log(...newMenu); //Pizza Pasta Risotto Gnocci   spread unpacked indivual elements
...
console.log(...menus); //Focaccia Bruschetta Garlic Bread Caprese Salad Pizza Pasta Risotto   spread unpacked the indiviual elements

// spread operator is work in all itarable  like string , arrays , maps, but not objects
// lets see  spread operator eg with strings
...
//we use here 'destructuring' and 'Rest'  and in the right side 'spread'
...
into a new object and not into a new array.So let's now work here with our opening hours
